...
const strings: { [key: string]: string | undefined } = {
  ...
  'chat.setStatus.timeout': 'Status timeout',
  'chat.setStatus.timeoutLabel.30-min': '30 Minutes',
  'chat.setStatus.timeoutLabel.1-hour': '1 Hour',
  'chat.setStatus.timeoutLabel.3-hour': '3 Hours',
  'chat.setStatus.timeoutLabel.12-hour': '12 Hours',
  'chat.setStatus.timeoutLabel.24-hour': '24 Hours',
  'chat.setStatus.timeoutLabel.none': 'None',
  'chat.menu': 'Menu',
