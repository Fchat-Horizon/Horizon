...
// note: `app` is main-only, but common.ts pokes at it on paths that never
//        run in a renderer. Exporting undefined here keeps webpack from
//        crying about it at build time.
