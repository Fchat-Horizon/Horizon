 ...
 *
 * ^ All file IO lives in the main process (electron/filesystem-host.ts); this
 * module proxies over IPC and only reattaches live character objects to the
 * plain records that come back.
 */
...
import type { PlainLogMessage } from '@main/log-format';
