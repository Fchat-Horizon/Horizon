  ...
  export default defineComponent({
    ...
    computed: {
      styling(): string {
        ...
        // ^ Fall back without mutating settings: computed must stay pure.
...
<style lang="scss">
  ...
  /* Pin footer height so resizing the window doesn't resize it. */
  ...
  /* Scale changelog media to the window while preserving aspect ratio. */
  .logs-container img {
    max-width: 100%;
    height: auto;
    display: block;
