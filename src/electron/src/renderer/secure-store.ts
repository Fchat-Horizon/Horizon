...
import type { KeyValueStore } from '@main/json-store';
 ...
 *
 * note: On-disk format (binary-encoded safeStorage buffers in the settings
 * JSON) is unchanged from the old @electron/remote version, so previously
 * saved credentials keep working.
 */
