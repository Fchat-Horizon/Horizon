 ...
 * of things the UI actually needs get handed through the context bridge here.
 * On the other side, platform-host.ts injects this surface into the shared
 * platform/ipc seam, and host-bridge.ts wraps it for electron's own renderers.
 */
...
contextBridge.exposeInMainWorld('electronAPI', {
   ...
   * the message arguments without the IpcRendererEvent; host-bridge.ts
